<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="asset/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?= $_SESSION['nama'] ?></span>
              </a>
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a class="dropdown-item" href="sessi/action/logout.php">Log out</a>
							</div>
						</li>
					</ul>
				</div>
